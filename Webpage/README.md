...
- **Performance-Based Questions (PBQ)** — 38 drag-and-drop matching labs + 12 advanced scenario labs (48 questions)
- **Linux Lab** — simulated shell environment with 8 guided lessons and 5 Security+ challenges
